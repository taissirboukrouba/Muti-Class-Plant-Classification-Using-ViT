...
var plants = [
  /* Indoor  ---------------------------------------------------------- */
  Plants(
      externalImage: "assets/images/BiggerPictures/Indoor/Strelitzia.jpeg",
      ...
      light: "high ",
      Description:
          "Strelitzia is a South African perennial plant genus with five species. It is a member of the Strelitziaceae family of plants.\nBecause the blooms resemble those of birds-of-paradise, the genus is known as bird of paradise flower/plant. It's also known as the crane flower in South Africa.It grows best indoors in a bright, sunny location with healthy, loamy, well-drained soil"),
  Plants(
      externalImage: "assets/images/BiggerPictures/Indoor/Algerian Ivy.jpeg",
      ...
      light: "Partial ",
      Description:
          " Algerian ivy is a woody climbing vine with big leaves. It grows to be 8-10 tall but may climb to great heights.\nIt may be grown as a ground cover, but it must be limited because it can be weedy and may require extensive pruning to keep in check. To avoid leaf drop, moisture levels should be generally stable."),
  Plants(
      externalImage:
          "assets/images/BiggerPictures/Indoor/Mexican Snowball.jpeg",
      ...
      light: "high ",
      Description:
          "Echeveria is a genus of plants in the Crassulaceae family. Because of their gritty texture, these plants make wonderful complements in rock or crevice gardens.\nThey're also a popular home plant due to their modest size at maturity, which is often less than a foot.These plants thrive in bright sunshine and well-drained soil with a small amount of organic materials. Too much direct sunshine can cause leaf burn, yet not enough light can cause color loss. Water once a week, never allowing the soil completely dry up.\nThey are beginner-friendly houseplants that are simple to care for."),
  Plants(
      externalImage: "assets/images/BiggerPictures/Indoor/Corn plant.jpeg",
      ...
      light: "medium ",
      Description:
          "Corn plant is a slow-growing, broadleaf evergreen perennial shrub native to tropical Africa, however it is commonly grown as a houseplant . It belongs to the Asparagaceae (asparagus) family and is known as a corn plant due to the tall, unbranched stem's similarity to a corn stalk.\nIndoors, keep it in bright to moderate filtered light. It thrives in low-light environments. The foliage can be burned by direct sunlight, but if the light levels are too low, the leaves will narrow. During the growth season, keep the soil wet, but reduce the amount of water used in the winter. Plant in a container with drainage holes and commercially packaged potting soil. Place a saucer beneath the plant to collect any excess water and then discard it."),
  Plants(
      externalImage: "assets/images/BiggerPictures/Indoor/Ceriman.jpeg",
      ...
      light: "high ",
      Description:
          "Ceriman is a woody epiphytic vine that climbs via adventitious roots, not a philodendron. It begins life as a terrestrial plant, but when it comes into touch with a robust tree it can climb, it transforms into an epiphyte, sending down long roots to obtain nutrients from the soil.\nIt is native to tropical parts of North and South America and may reach a height of 70 feet, while most home situations keep it around 6-8 feet. In its natural environment, delicious fruit is produced that is claimed to taste like a hybrid between a banana and a pineapple. The rest of the plant is poisonous. It can be grown as a houseplant."),
  Plants(
      externalImage: "assets/images/BiggerPictures/Indoor/Snake plant.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Indoor/Lady palm.jpeg",
  ...
  Plants(
      externalImage:
          "assets/images/BiggerPictures/Indoor/Baby Rubber plant.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Indoor/Asparagus Fern.jpeg",
  ...
  /* Flowers ---------------------------------------------------------- */
  Plants(
      externalImage: "assets/images/BiggerPictures/Flowers/Liluim.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Flowers/Roses.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Flowers/Tulip.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Flowers/Moon orchid.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Flowers/Deptford pink.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Flowers/Chrysanthemum.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Flowers/Baboon flower.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Flowers/Peruvian Lily.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Flowers/Sword Lily.jpeg",
  ...
  Plants(
      externalImage: "assets/images/BiggerPictures/Flowers/Windflower.jpeg",
...
/*----------------------------------------------------------- OUTDOOR --------------------------------------------*/
  Plants(
      externalImage:
          "assets/images/BiggerPictures/Outdoor/Canary date palm.jpeg",
  ...
  Plants(
      externalImage:
          "assets/images/BiggerPictures/Outdoor/Climbing Euonymus.jpeg",
  ...
  Plants(
      externalImage:
          "assets/images/BiggerPictures/Outdoor/Chinese Hibiscus.jpeg",
  ...
  /*------------------------------------------*/
  Plants(
      externalImage: "assets/images/BiggerPictures/Outdoor/Bay Laurel.jpeg",
  ...
  /*------------------------------------------*/
  Plants(
      externalImage: "assets/images/BiggerPictures/Outdoor/African Lily.jpeg",
  ...
  /*------------------------------------------*/
  Plants(
      externalImage: "assets/images/BiggerPictures/Outdoor/Princess Lily.jpeg",
  ...
  Plants(
      externalImage:
          "assets/images/BiggerPictures/Outdoor/Weeping Bottlebrush.jpeg",
  ...
  /*------------------------------------------*/
  Plants(
      externalImage: "assets/images/BiggerPictures/Outdoor/Hardy Fushia.jpeg",
  ...
  Plants(
      externalImage:
          "assets/images/BiggerPictures/Outdoor/Lochinch Butterfly.jpeg",
  ...
  Plants(
      externalImage:
          "assets/images/BiggerPictures/Outdoor/Flowering Maple.jpeg",
